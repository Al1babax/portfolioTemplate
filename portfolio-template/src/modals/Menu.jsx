...
export function Menu(props) {
    ...
    return (
        <div className={`menu w-[380px] 2xl:w-full h-full bg-gradient-to-tl from-neutral-800 via-neutral-600 to-red-400 absolute top-0 z-10 ${menuOpen ? "left-0" : "-left-[470px]"} duration-1000 ease-in-out`}>
